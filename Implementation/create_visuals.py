...
def create_visuals():
    ...
    test_users = [901, 15651, 33319, 43962, 262118, 252846, 245128, 234567]
    ...
    with open("user_eval_sets/users_12_25_1_plus_STEM_books_and_10_plus_high_rated_split_60_40.json", 'r') as file:
        ...
        for item in tqdm(data):
            ...
            saveGraphVector(old_profile_vector, f"User Profile {user_id} from Concatenation", "visuals")
            saveGraphVector(new_proflie_vector, f"User Profile {user_id} from Bilinear Pool", "visuals")
