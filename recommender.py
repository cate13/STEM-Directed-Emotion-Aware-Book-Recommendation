...
TEST_DATA_FILE = "user_eval_sets/users_12_19_1_plus_STEM_books_and_10_plus_high_rated_split_60_40.json"
...
def recommend(test_data_file, emotion_type = "emotion_intensity", topic_type = "tf_idf", emotion_weight = 1.0, topic_weight = 1.0, use_matrix_combo = False, reduce = False):
    ...
    if use_matrix_combo & reduce:
        output_file_name = f"recommendations/12_19_age_10_plus_high_rated_books/{emotion_type}_reduced_{topic_type}_correlation_combo_with_{emotion_weight}.json"
    elif use_matrix_combo:
        output_file_name = f"recommendations/12_19_age_10_plus_high_rated_books/{emotion_type}_{topic_type}_correlation_combo_with_{emotion_weight}.json"
    else:
        output_file_name = f"recommendations/12_19_age_10_plus_high_rated_books/{emotion_type}_with_weight_{emotion_weight}_{topic_type}_with_weight_{topic_weight}.json"
